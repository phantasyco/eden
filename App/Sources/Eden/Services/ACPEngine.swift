...
extension AgentThread {
    ...
    private func acpSession(in folder: URL) async throws -> ACPSession {
        ...
        if repo.machine.isLocal {
            ...
            fresh = ACPSession(name: agent.displayName, executable: executable, arguments: acpArguments, cwd: folder, configuration: acpConfiguration)
        } else {
            ...
            fresh = ACPSession(name: agent.displayName, executable: remote.executable, arguments: remote.arguments,
