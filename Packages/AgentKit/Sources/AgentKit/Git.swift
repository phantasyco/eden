...
public struct EdenError: LocalizedError {
...
public enum Git {
    ...
    @discardableResult
    public static func run(_ args: [String], in dir: URL, on machine: Machine = .local) throws -> String {
    ...
    public static func raw(_ args: [String], in dir: URL, on machine: Machine = .local) throws -> Shell.Output {
    ...
    public static func isRepository(_ folder: URL, on machine: Machine = .local, refresh: Bool = false) -> Bool {
    ...
    public static func branches(of repo: URL, on machine: Machine = .local) -> [String] {
    ...
    public static func remoteOwner(of repo: URL) -> String? {
    ...
    public static func create(at folder: URL) throws {
    ...
    public static func clone(_ remote: String, into parent: URL) throws -> URL {
    ...
    public static func stageAttachments(_ files: [URL], in folder: URL) throws -> [String] {
    ...
    public static func currentBranch(of repo: URL, on machine: Machine = .local) -> String? {
    ...
    public static func createWorktree(repo: URL, name: String, base: String? = nil) throws -> (path: URL, branch: String) {
        let base = base ?? "HEAD"
    ...
    public static func diff(worktree: URL, on machine: Machine = .local) throws -> String {
    ...
    public static func commitAll(worktree: URL, message: String, on machine: Machine = .local) throws -> String {
