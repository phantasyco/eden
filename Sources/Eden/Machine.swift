...
enum Machine: Hashable, Codable {
    ...
    func command(_ executable: String, _ arguments: [String], in folder: String?, terminal: Bool = false) -> (executable: String, arguments: [String]) {
    ...
    func shell(in folder: String) -> (executable: String, arguments: [String])? {
