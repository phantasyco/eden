...
class AgentProcess: @unchecked Sendable {
    ...
    init(executable: String, arguments: [String], cwd: URL, configuration: String) {
    ...
    var isAlive: Bool { process.isRunning && !lock.withLock { closed } }
...
final class ClaudeSession: AgentProcess, @unchecked Sendable {
    ...
    func respond(to requestID: String, with response: [String: Any]) {
    ...
    func decline(_ requestID: String, reason: String) {
