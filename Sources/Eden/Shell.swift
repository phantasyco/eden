...
enum Shell {
    ...
    @discardableResult
    static func run(_ executable: String, _ arguments: [String], cwd: URL?, environment: [String: String]? = Shell.environment) throws -> Output {
        let process = Process()
    ...
    static func open(_ url: URL, withApp app: String? = nil) {
        var args: [String] = []
